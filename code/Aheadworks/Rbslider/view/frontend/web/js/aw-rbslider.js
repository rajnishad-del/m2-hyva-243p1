 ...
 */
define([
  "jquery", // ❌ Dependency 1: jQuery library
  "uikit!slideshow", // ❌ Dependency 2: UIkit Slideshow component
  "moment", // ❌ Dependency 3: Moment.js for date/time handling
  ...
  $.widget("mage.awRbslider", {
    ...
    resizeBanner: function (slideshow) {
      ...
      if (slideshow.slides.length) {
        width = $(slideshow.slides[0])
          .find("img.aw-rbslider__img")
          .prop("naturalWidth");
      }
    ...
    delayedUpdate: function (futureTime) {
      ...
      interval = moment(
        moment(futureTime, "YYYY-MM-DD HH:mm").diff(
          moment(currentDate, "YYYY-MM-DD HH:mm")
        )
      );
    ...
    _randomSort: function () {
      ...
      $(this.element)
        .find(sliderListSelector)
        .html(
          $(this.element)
            .find(sliderListSelector + " " + sliderItemSelector)
            .sort(function () {
