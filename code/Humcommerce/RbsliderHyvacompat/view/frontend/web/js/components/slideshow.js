(() => {
  ...
  window.awRslider = function (element, config) {
    "use strict";
    ...
    const slideshow = {
      ...
      init() {
        ...
        this.fixFullscreen =
          ...
          this.container.classList.contains("uk-slideshow-fullscreen"); // viewport unit fix for height:100vh - should be fixed in iOS 8
        ...
        Array.from(
          ...
          item.addEventListener("click.uk.slideshow", (e) => {
            ...
            let slide = item.getAttribute("data-uk-slideshow-item");
        ...
        const resizeCallback = () => {
          ...
          if (this.fixFullscreen) {
            ...
            this.slides.map(
              (slide) => (slide.style.height = window.innerHeight + "px")
            );
          }
        };
        window.addEventListener("resize", resizeCallbackDebounce);
        window.addEventListener("load", resizeCallbackDebounce);
      ...
      resize: function () {
        if (this.container.classList.contains("uk-slideshow-fullscreen"))
          return;
